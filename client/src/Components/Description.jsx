...
const Description = () =>{
    ...
    transition={{duration:1}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
        className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
            ...
            <p className='text-gray-500 mb-8'>Turn yourimaginatioin into visuals</p>
            ...
            <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
                ...
                <div>
                    ...
                    <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator. 
                        Whether you need stunning visuals or unique
                    ...
                    <p className='text-gray-600'>Simply type in a text prompt, and our cutting-edge AI will 
                        ...
                        character designs and portraits, even concepts that don’t yet exist 
                         be visualized effortlessly. Powered by advanced AI technology, the creative
